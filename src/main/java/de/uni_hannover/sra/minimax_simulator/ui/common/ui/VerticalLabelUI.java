 ...
 */
package de.uni_hannover.sra.minimax_simulator.ui.common.ui;
...
public class VerticalLabelUI extends BasicLabelUI
{
	...
	/**
	 * Overridden to always return Component.BaselineResizeBehavior.OTHER, since a vertical label
	 * does not have a meaningful baseline
	 * 
	...
	/**
	 * Transposes the view rectangles as appropriate for a vertical view before invoking the super
	 * method and copies them after they have been altered by
	...
	public void paint(Graphics g, JComponent c)
	{
		...
		if (clockwise)
		{
//			g2.translate(c.getSize().width / 2, c.getSize().width / 2);
