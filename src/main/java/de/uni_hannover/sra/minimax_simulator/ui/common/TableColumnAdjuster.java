/* Source: http://tips4java.wordpress.com/2008/11/10/table-column-adjuster/ */
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener
{
	...
	private int getColumnHeaderWidth(int column)
	{
		...
		Component c = renderer.getTableCellRendererComponent(table, value, false, false,
			-1, column);
...
//
	...
	private void installColumnAction(boolean isSelectedColumn, boolean isAdjust,
			String key, String keyStroke)
	{
	...
	private void installToggleAction(boolean isToggleDynamic, boolean isToggleLarger,
			String key, String keyStroke)
	{
