...
import de.uni_hannover.sra.minimax_simulator.gui.common.NumberTextField;
import de.uni_hannover.sra.minimax_simulator.gui.util.JumpLabelSelector;
...
/**
 * An {@code FXJumpTargetDialog} is basically an {@link FXDialog} with customized content.<br>
 * The {@code FXJumpTargetDialog} is the UI used to change the {@link Jump} of a {@link SignalRow}.
 *
 * @author Philipp Rohde
 */
public class FXJumpTargetDialog extends FXDialog {
     ...
     */
    public FXJumpTargetDialog(SignalTable table, SignalRow row, int rowIndex) {
