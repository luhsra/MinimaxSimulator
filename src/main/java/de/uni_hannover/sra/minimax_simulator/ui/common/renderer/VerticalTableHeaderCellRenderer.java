...
import de.uni_hannover.sra.minimax_simulator.ui.common.ui.VerticalLabelUI;
import de.uni_hannover.sra.minimax_simulator.ui.common.ui.VerticalLabelUI2;
...
public class VerticalTableHeaderCellRenderer extends DefaultTableHeaderCellRenderer
{
	 ...
	 * <P>
	 * The horizontal and vertical alignments and text positions are set as appropriate to a
	 * vertical table header cell.
	 */
	public VerticalTableHeaderCellRenderer()
	{
		...
		setUI(new VerticalLabelUI2(false));
	}
	...
	private enum VerticalSortIcon implements Icon
	{
		...
		/**
		 * Paints an icon suitable for the header of a sorted table column, rotated by 90°
